...
def read_sensor():
    try:
        ...
        # temp/humidity sensor sometimes gives nan
...
try:
    # Run scheduled tasks
    scheduler.enter(config_pump_time, 1, activate_pumps, (s,))
    scheduler.enter(config_upload_time, 1, upload_readings, (s,))
    scheduler.run()
